...
namespace BaseAutomation.Hooks
{
    [Binding]
    public sealed class SetUp
    {
        ...
        {
            var htmlReporter = new ExtentHtmlReporter(@"C:\Users\jsaldanav\source\repos\CSharpFramework\SeleniumFramework\Reports\ExtentReport.html");
